    ...
    <nav className="fixed bottom-0 left-0 right-0 z-30 bg-white/95 backdrop-blur-md border-t border-slate-200/90 shadow-lg px-2 py-1.5 transition-all">
      <div className="max-w-md mx-auto flex items-center justify-around">
        ...
        <button
          ...
          className={`flex-1 py-1 flex flex-col items-center justify-center gap-0.5 rounded-xl transition active-press cursor-pointer ${
            activeTab === 'home'
              ? 'text-[#28811f] font-bold'
              : 'text-slate-500 hover:text-slate-800'
          }`}
        >
          <div className={`p-1 rounded-xl ${activeTab === 'home' ? 'bg-[#28811f] text-white font-bold' : ''}`}>
        ...
        <button
          ...
          className={`flex-1 py-1 flex flex-col items-center justify-center gap-0.5 rounded-xl transition active-press cursor-pointer relative ${
            activeTab === 'library'
              ? 'text-[#28811f] font-bold'
              : 'text-slate-500 hover:text-slate-800'
          }`}
        >
          <div className={`p-1 rounded-xl ${activeTab === 'library' ? 'bg-[#28811f] text-white font-bold' : ''}`}>
        ...
        >
          <div className={`p-1 rounded-xl ${activeTab === 'courses' ? 'bg-[#28811f] text-white font-bold' : ''}`}>
        ...
        >
          <div className={`p-1 rounded-xl ${activeTab === 'help' ? 'bg-[#28811f] text-white font-bold' : ''}`}>
