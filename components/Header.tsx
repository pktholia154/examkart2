  ...
  return (
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md px-4 py-3 border-b border-slate-100 flex items-center justify-between transition-all">
      ...
      <div className="flex items-center gap-2.5">
        <div className="w-10 h-10 rounded-xl bg-[#28811f] text-white flex items-center justify-center font-bold text-xl shadow-sm tracking-tight shrink-0">
          E
        </div>
        <div>
          <div className="flex items-center gap-1.5">
            <h1 className="text-xl font-extrabold tracking-tight text-[#28811f]">
              ExamKart
            </h1>
          ...
          <div className="relative">
            ...
            >
              {userPhoto ? (
                ...
                <div className="w-7 h-7 rounded-full bg-[#28811f] text-white flex items-center justify-center font-bold text-xs">
